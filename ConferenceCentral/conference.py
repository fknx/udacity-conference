...
SESSION_GET_REQUEST_WITH_TYPE = endpoints.ResourceContainer(
    message_types.VoidMessage,
    websafeConferenceKey=messages.StringField(1),
...
ADD_TO_WISHLIST = endpoints.ResourceContainer(
    message_types.VoidMessage,
...
# - - - Session objects - - - - - - - - - - - - - - - - - - -
    ...
    @endpoints.method(SESSION_POST_REQUEST, SessionForm, 
            path='conference/{websafeConferenceKey}/sessions/add',
            http_method='POST',
            name='createSession')
    ...
    def getConferenceSessions(self, request):
        ...
        # fetch all sessions having the conference as ancestor
    ...
    @endpoints.method(SESSION_GET_REQUEST_WITH_TYPE, SessionForms,
    ...
    def getConferenceSessionsByType(self, request):
        ...
        # fetch all sessions having the conference as ancestor and a matching type
        sessions = Session.query(ancestor=key).filter(Session.typeOfSession == request.typeOfSession)
    ...
    def addSessionToWishlist(self, request):
        ...
        if key in profile.wishlist:
            raise endpoints.BadRequestException('The session is already on the users wishlist.')

        # add the session to the wishlist and store the profile
        profile.wishlist.append(key)
        profile.put()
